...
const Site = () => {
    const way = "./projets/site/"
    const data = [
        { title: 'Site React Patisserie', 
            imgs: way+"atelier", 
            len: 4,
            format: "PNG",
            link: "https://atelier-dharma.fr", content: `
        ...
        {
            title: "Site pour une association événementielle",
            imgs: way+"medieval" ,
            len: 4,
            format: "png",
            link:"https://site-medievale.vercel.app/",
            content:`
            Faisant partie de l'association Les Médiévales d’Asnières-sur-Oise, j'ai décidé de participer à sa popularisation en leur faisant un site internet.
            Il permet de montré les prochains événements, de décrire se que propose l'association pour faire vivre la ville.
            `
        },
        {
            title:"Site Naturopathie",
            imgs: way+"naturo",
            len:4,
            format: "png",
            link:"https://www.harmonienaturo.fr/",
            content: ""
        },
        {
            title: 'Site pour notre groupe de danse',
            imgs: way+"uju",
            len:3,
            link: "https://site-ujuicy.vercel.app/",
            format: "png",
            content: `
                Pour promouvoir mon groupe de danse, j'ai décidé de faire un site internet qui permet de montrer notre motivation.
            `
        },

        { title: 'Librairie de composants React personnalisables', 
            imgs: way+"lib_component", 
            len: 3,
            format: "PNG",
            link: 'https://library-react-xi-lovat.vercel.app/', content: `
        ...
        { 
            title: 'Site Django Article', 
            imgs: way+"django", 
            len: 5,
            format: "PNG",
            link: 'https://django-multilang-site-deploy.vercel.app/', content: `
...
`       },
        {
            title: "Application de Quiz (Android, Jetpack Compose)", 
            imgs: way+"android", 
            len: 5,
            format: "png",
            link: null, content: `
    ...
    return(
        ...
        <section id="portfolio" className="portfolio">
            <h1>Mes projets réalisés en programmation</h1>
            <p>Au fil de mes études, j’ai eu l’occasion de réaliser divers projets en programmation, mêlant à la fois apprentissage académique et mise en pratique concrète. 
                Ces projets m'ont permis de renforcer mes compétences techniques tout en développant ma capacité à répondre à des besoins réels. 
                Qu’il s’agisse de travaux réalisés dans un cadre scolaire ou de solutions créées pour aider mes proches, chaque projet m’a permis d’explorer de nouvelles technologies et d’apporter des réponses efficaces et personnalisées.</p>
            <div className="gallery" key={"portfolio"}>
                {data.map((site) => (
                    <ContainerProjet title={site.title} dirImg={site.imgs} len={site.len} format={site.format} link={site.link} content={site.content} key={site.title}/>
                ))}
            </div>
        </section>
        </>
